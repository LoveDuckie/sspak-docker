...
export SILVERSTRIPE_VARS=(SS_DATABASE_SERVER SS_DATABASE_USERNAME SS_DATABASE_NAME SS_DATABASE_PORT)

# export SS_DATABASE_SERVER=${SS_DATABASE_SERVER:-"portfolio-database"}
# export SS_DATABASE_SERVER=${SS_DATABASE_SERVER:-"portfolio-database"}
# export SS_DATABASE_USERNAME=${SS_DATABASE_USERNAME:-}
...
export BACKUP_FILENAME_PREFIX=${BACKUP_FILENAME_PREFIX:-"silverstripe-backup-"}
